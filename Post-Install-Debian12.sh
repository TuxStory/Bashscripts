...
# 19/06/2023 - ver 1.0.2 02/12/2024 #
# Antoine Even                      #
#####################################
...
Programmes_Console="ansiweather bash-completion bmon dfc duf ethstatus ethtool curl fbi htop irssi inxi lm-sensors ncdu neofetch nvtop mc nmon oping ranger rsync slurm smartmontools tmux wavemon wget w3m w3m-img"
