...
sudo dnf install -y borgbackup dfc ethtool fastfetch htop iftop inxi iperf3 nano ncdu nethogs nload nmon mc ranger \
		screen slurm smartmontools timeshift tmux vnstat
