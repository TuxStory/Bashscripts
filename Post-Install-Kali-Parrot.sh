...
# 21/03/2024 - ver 0.0.5 22/03/2024 #
# Antoine Even                      #
#####################################
...
Programmes_Hacking="binwalk cewl gobuster hashcat hydra john lynis nessus netcat nmap wifite wireshark wordlisctl perl-image-exiftool strings"
