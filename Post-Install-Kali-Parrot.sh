...
# 21/03/2024 - ver 0.1.0 26/03/2024 #
# Antoine Even                      #
#####################################
...
Programmes_Hacking="binwalk cewl foremost gobuster hashcat hydra john lynis nmap wifite wireshark wordlisctl libimage-exiftool-perl binutils"
