...
sudo pacman -S --noconfirm bat btop borgbackup dfc duf fastfetch exfat-utils fuse3 nano nmap tmux timeshift inxi screen htop ncdu nload nethogs nmon \
