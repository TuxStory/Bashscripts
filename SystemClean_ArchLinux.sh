...
# Intro
echo -e "\n${GREEN}===== System${WHITE}Cleaner Ver: ${BLUE}$VERSION ${WHITE}for${RED} Arch Linux ${WHITE}base system${GREEN} ====="
...
################ PacMan
echo -e "\n${GREEN}>>> [ Cache ] ${WHITE}Nettoyage du cache PacMan."
sudo paccache -r

#echo -e "\n${GREEN}>>> [ Obseletes Files] ${WHITE}Nettoyage des porgrammes obselètes."
