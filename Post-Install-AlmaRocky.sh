...
sudo dnf install -y bat bash-completion btop borgbackup dfc ethtool fastfetch gnome-tweaks htop inxi iperf3 nano nmon ncdu nethogs nload nmon ranger \
