...
sudo dnf install -y htop dfc fastfetch nano tmux inxi screen htop nload nethogs ncdu nmon ranger timeshift \
	vnstat smartmontools ethtool iperf3 borgbackup #duf
